                            ...
                            <div class="col-lg-12">
                                <div class="form-group  col-lg-4  pull-right" dir="rtl">
                                    ...
                                    <select name="client_category" class="form-control" required>
                                        ...
                                        <option
                                            @if($outer_client->client_category == "جملة")
                                            selected
                                            @endif
                                            value="جملة">
                                            @if(App::getLocale() == 'ar')
                                        ...
                                        <option
                                            @if($outer_client->client_category == "قطاعى")
                                            selected
                                            @endif
                                            value="قطاعى">
                                            @if(App::getLocale() == 'ar')
                                ...
                                <div class="form-group  pull-right col-lg-4" dir="rtl">
                                    ...
                                    <select name="client_national" class="form-control">
                                        ...
                                        @foreach($timezones as $timezone)
                                            <option
                                                @if($outer_client->client_national == $timezone->name_ar)
                                                selected
                                                @endif
                                ...
                                <div class="form-group  pull-right col-lg-4" dir="rtl">
                                    ...
                                    <input type="text" name="tax_number"
                                           value="{{$outer_client->tax_number}}" class="form-control" dir="ltr"/>
                                </div>
                                <div class="clearfix"></div>
