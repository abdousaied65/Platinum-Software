            ...
            <div class="card mg-b-20">
                <div class="card-body">
                    ...
                    <form class="parsley-style-1" id="selectForm2" name="selectForm2"
                          action="{{route('client.update.cashbank.suppliers',$buy_cash->id)}}"
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                            <button class="btn btn-info pd-x-20" type="submit">تعديل
                                @if(App::getLocale() == 'ar')
                                    تحديث
                                @else
                                    Update
