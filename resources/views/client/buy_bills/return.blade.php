    ...
    <form action="{{route('client.buy_bills.post.return')}}" method="post">
        ...
        <div class="row mt-2 mb-2">
            <div class="col-lg-3 pull-right no-print">
                ...
                <input type="hidden" value="{{$buy_bill->supplier->id}}" required name="supplier_id"
                       id="supplier_id"/>
        ...
        <div class="row mt-1 mb-1">
            ...
            <div class="col-lg-3 pull-right">
                <div class="form-group" dir="rtl">
                    ...
                    <input type="text" name="balance_after" id="balance_after" readonly class="form-control"
                           required>
                </div>
            </div>
        </div>
