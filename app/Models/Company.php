...
class Company extends Model
{
    ...
    protected $fillable = [
        ...
        'tax_number','commercial_registration_number','tax_value_added','company_logo','status','notes',
    ...
    {
        return $this->hasMany('\App\Models\Engineer', 'company_id', 'id');
    }
    public function maintenance_devices()
    {
        return $this->hasMany('\App\Models\MaintenanceDevice', 'company_id', 'id');
    }
