...
class Client extends Authenticatable
{
    ...
    {
        return $this->hasMany('\App\Models\PosOpen', 'client_id', 'id');
    }

    public function sale_bills()
    {
        return $this->hasMany('\App\Models\SaleBill', 'client_id', 'id');
    }

    public function cashs()
    {
        return $this->hasMany('\App\Models\Cash', 'client_id', 'id');
    }

    public function bank_cashs()
    {
        return $this->hasMany('\App\Models\BankCash', 'client_id', 'id');
    }
