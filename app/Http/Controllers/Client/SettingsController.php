...
class SettingsController extends Controller
{
    ...
    public function screens_settings_update(Request $request)
    {
        ...
        if (in_array('maintenance', $screens)) {
            $screen_settings->maintenance = "1";
            $screen_settings->save();
        }
        else{
            $screen_settings->maintenance = "0";
            $screen_settings->save();
        }
    ...
    public function pos_settings()
    {
        ...
        return view('client.settings.pos', compact('company','pos_settings'));
    }
    ...
    public function pos_settings_edit($id)
    {
        ...
        $safes = $company->safes;
        $banks = $company->banks;
        return view('client.settings.edit_pos', compact('pos_setting','safes','banks', 'company_id', 'company', 'branches'));
    }
    ...
    public function billing()
    {
        ...
        return view('client.settings.billing', compact('company', 'taxes'));
    }
